...
import profileImage from "/images/profile3.jpeg";
            ...
            <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="animate-slide-up">
                    ...
                    <p className="text-lg sm:text-xl lg:text-2xl text-muted-foreground mb-8 max-w-2xl mx-auto animate-fade-in-delay">
                        Crafting robust, scalable backend systems that power
                        modern applications. Specialized in API design, database
                        optimization, and cloud architecture.
                    </p>
